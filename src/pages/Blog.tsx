...
export default function Blog() {
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      <SEO 
        title="Tin tức & Blog Viettel Đắk Lắk - Cập nhật 2026"
        description="Cập nhật tin tức công nghệ, khuyến mãi lắp mạng Viettel, giải pháp số doanh nghiệp tại Đắk Lắk. Kinh nghiệm khởi nghiệp và chuyển đổi số."
        keywords="tin tức viettel đắk lắk, blog công nghệ đắk lắk, khuyến mãi viettel đắk lắk, lắp mạng viettel buôn ma thuột"
      />
      {/* Hero Section */}
