          ...
          <div className="max-w-4xl">
            ...
            >
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white border border-slate-200 rounded-full mb-8 backdrop-blur-md">
                ...
                <span className="text-slate-900/80 text-[10px] font-black uppercase tracking-[0.3em]">Giải pháp ký kết số 1 Việt Nam</span>
              </div>
              <h1 className="text-5xl md:text-8xl font-black text-slate-900 mb-8 leading-none tracking-tighter uppercase">
                HỢP ĐỒNG <br /><span className="text-viettel-red">ĐIỆN TỬ</span> <br />VCONTRACT
              </h1>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium max-w-2xl">
                Số hóa toàn diện quy trình ký kết. Ký kết mọi lúc, mọi nơi, trên mọi thiết bị với tính pháp lý được đảm bảo 100% theo quy định pháp luật.
              </p>
