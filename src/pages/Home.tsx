...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const schemaData = {
      ...
      "sameAs": [
        "https://www.facebook.com/vietteldaklak"
      ]
    };
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="hero-content max-w-5xl">
            ...
            <h1 className="text-6xl md:text-9xl font-black text-slate-900 leading-none mb-10 tracking-tighter uppercase">
              DỊCH VỤ <br />
              <span className="text-viettel-red">VIETTEL</span> <br />
              TẠI ĐẮK LẮK
            </h1>
            <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium max-w-2xl">
              Lắp mạng Internet Wifi, <Link to="/digital-signature" className="text-viettel-red hover:underline">Chữ ký số</Link>, <Link to="/e-invoice" className="text-viettel-red hover:underline">Hóa đơn điện tử</Link>, <Link to="/e-contract" className="text-viettel-red hover:underline">Hợp đồng điện tử</Link> và <Link to="/business" className="text-viettel-red hover:underline">Giải pháp doanh nghiệp</Link> trọn gói tại Đắk Lắk. Hỗ trợ nhanh chóng 24/7 bởi chuyên viên Viettel.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link to="/contact" className="btn-primary px-12 py-5 text-lg shadow-2xl shadow-viettel-red/20 group">
      ...
      <section ref={pricingRef} className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24 animate-on-scroll">
            <h2 className="text-4xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter mb-6">BẢNG GIÁ <span className="text-viettel-red">INTERNET 2026</span></h2>
            <p className="text-slate-600 text-xl font-medium">Gói cước cáp quang tốc độ cao dành cho gia đình & doanh nghiệp tại Đắk Lắk.</p>
          </div>
