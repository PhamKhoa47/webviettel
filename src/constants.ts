...
export const PRICING_INTERNET = [
  { 
    ...
    speed: '300 Mbps', 
    price: '195.000đ', 
    features: ['Phí lắp đặt: 300.000đ', 'Trang bị Modem Wifi 6 (ONT Dualband)', 'Phù hợp cá nhân, sinh viên', 'Tốc độ ổn định, giá rẻ'] 
  },
  { 
    name: 'NETVT2_T', 
    speed: '500Mbps - 1Gbps', 
    price: '240.000đ', 
    features: ['Phí lắp đặt: 300.000đ', 'Trang bị Modem Wifi 6 (ONT Dualband)', 'Phù hợp hộ gia đình 4-6 thiết bị', 'Băng thông lớn, mượt mà'] 
  },
  { 
    name: 'MESHVT1_T', 
    speed: '300 Mbps', 
    price: '210.000đ', 
    features: ['Phí lắp đặt: 300.000đ', 'Trang bị Modem Wifi 6 + 01 Mesh Wifi', 'Phủ sóng căn hộ 1-2 phòng ngủ', 'Công nghệ Mesh hiện đại'] 
  },
  { 
    name: 'MESHVT2_T', 
    speed: '500Mbps - 1Gbps', 
    price: '245.000đ', 
    features: ['Phí lắp đặt: 300.000đ', 'Trang bị Modem Wifi 6 + 02 Mesh Wifi', 'Phủ sóng nhà tầng, căn hộ rộng', 'Roaming mượt mà toàn bộ nhà'] 
  },
  { 
    name: 'MESHVT3_T', 
    speed: '500Mbps - 1Gbps', 
    price: '299.000đ', 
    features: ['Phí lắp đặt: 300.000đ', 'Trang bị Modem Wifi 6 + 03 Mesh Wifi', 'Tốc độ tối đa lên đến 1Gbps', 'Giải pháp cho biệt thự, nhà vườn'] 
  },
];
